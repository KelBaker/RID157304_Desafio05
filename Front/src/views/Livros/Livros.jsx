            ...
            {livros.map((livro) => (
              <li key={livro._id}> 
                ...
                <div className='botoes'>
                  <div>
                    <Link className='btn edit' to={`/livros/edicao/${livro._id}`} disabled={loading}>
                  ...
                  <div>
                    <button className='btn delete' onClick={() => { deleteLivro(livro._id) }} disabled={loading || deleting}>
